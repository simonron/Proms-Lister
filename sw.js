const CACHE='proms-lister-version-3.0.9-fix1';
const CORE=['./styles-v3.css','./app-v3.js','./ticket-reader-v3.js','./seat-map-header-v3.js','./browse-controls-v3.js','./browse-fixes-v3.js','./detail-delegate-v3.js','./heif-input-v3.js','./version-v3.js','./page-chrome-v3.js','./manifest.json','./icon.png','./data.json','./rah-seating-plan2.jpeg'];
