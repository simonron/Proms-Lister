...
const start=()=>{refresh();const app=document.getElementById('app');if(app)new MutationObserver(refresh).observe(app,{childList:true});setTimeout(refresh,0);setTimeout(refresh,250)};
